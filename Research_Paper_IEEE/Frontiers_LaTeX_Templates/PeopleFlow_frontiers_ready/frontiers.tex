...
\def\Authors{Likith Sai Kunchi\,$^{1,*}$, [PhD Student Full Name]\,$^{2}$, [Faculty Guide Full Name]\,$^{3}$}
\def\Address{$^{1}$School of Computer Science and Engineering (SCOPE), VIT (Vellore Institute of Technology), Vellore, India \\
...
\title[PeopleFlow]{PeopleFlow: A Reproducible Geometry-Aware Multi-Agent Framework for Comparative Building Evacuation Safety Evaluation}
